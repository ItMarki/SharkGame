...
SharkGame.Gateway = {
    ...
    showGateway(baseReward, patienceReward, speedReward, gumptionRatio = gateway.getGumptionBonus()) {
        ...
        gatewayContent.append($("<p>").html("你是一條鯊魚，卡在世界之間的空間裏。"));
        if (!SharkGame.wonGame) {
            gatewayContent.append($("<p>").html("你不清楚你在這裏的緣故，但你知道，你曾經遭遇到一場痛苦的慘敗。").addClass("medDesc"));
        }
        ...
        if (baseReward > 0) {
            gatewayContent.append(
                $("<p>").html(
                    "進入這個地方，已經改變了你，給予了你 <span class='essenceCount'>" +
